...
MESSENGER_NEW_TASK_DSN="$amqpDSN%2f/new_task"
...
if [ "$useSfSeret" = "y" ]; then
  ...
  updateSecret "MESSENGER_NEW_TASK_DSN" "$MESSENGER_NEW_TASK_DSN"
  ...
  updateFile "$ENV_LOCAL_FILE" "MESSENGER_NEW_TASK_DSN" "$MESSENGER_NEW_TASK_DSN"
...
if [ "$useDockerCompose" = "y" ]; then
  ...
  updateFile "$DOCKER_COMPOSE_OVERRIDE_FILE" "MESSENGER_NEW_TASK_DSN" "$MESSENGER_NEW_TASK_DSN"
