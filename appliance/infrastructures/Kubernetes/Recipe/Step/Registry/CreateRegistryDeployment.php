...
class CreateRegistryDeployment
{
    ...
    private const string REPLICATION_SUFFIX = '-replication-dplmt';

    private const string LABEL_GROUP = 'private-registry';

    private const string CONTAINER_REGISTRY = 'registry';

    private const string CONTAINER_AUTH_VOLUME = 'auth-credentials';

    private const string CONTAINER_IMAGE_VOLUME = 'images-storage';
    ...
    private function configureRegistry(
        ...
        $this->datesService->passMeTheDate(
            static function (DateTimeInterface $dateTime) use ($accountHistory, $registryUrl, $username): void {
