...
/**
 * Kubernetes environment reinstall: remove the persisted environment then re-run the Kubernetes
 * {@see AccountEnvironmentInstall}. Executed in the `new_task` worker through the
