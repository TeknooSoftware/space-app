...
class DisableCommand extends Command
{
    ...
    {
        $this->setName('teknoo:space:extension:disable')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $enabledExtensions = array_diff($enabledExtensions, [$availablesExtensions[$extensionName]]);

        $this->updateEnabledExtensions($enabledExtensions);

        $output->writeln("<info>Extension $extensionName is disabled.</info>");
