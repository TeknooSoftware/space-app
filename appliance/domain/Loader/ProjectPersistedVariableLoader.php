 ...
 * @author      Richard Déloge <richard@teknoo.software>
 *
 * @implements LoaderInterface<ProjectPersistedVariable>
 */
class ProjectPersistedVariableLoader implements LoaderInterface
{
    /**
     * @use LoaderTrait<ProjectPersistedVariable>
     */
    use LoaderTrait;

    public function __construct(
        PersistedVariableRepositoryInterface $repository,
    ) {
