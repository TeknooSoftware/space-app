 ...
 * @author      Richard Déloge <richard@teknoo.software>
 *
 * @implements LoaderInterface<AccountPersistedVariable>
 */
class AccountPersistedVariableLoader implements LoaderInterface
{
    /**
     * @use LoaderTrait<AccountPersistedVariable>
     */
    use LoaderTrait;
