 ...
 * @author      Richard Déloge <richard@teknoo.software>
 *
 * @implements LoaderInterface<AccountCluster>
 */
class AccountClusterLoader implements LoaderInterface
{
    /**
     * @use LoaderTrait<AccountCluster>
     */
    use LoaderTrait;

    public function __construct(AccountClusterRepositoryInterface $repository)
    {
