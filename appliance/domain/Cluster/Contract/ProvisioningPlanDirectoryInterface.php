...
namespace Teknoo\Space\Cluster\Contract;

use Teknoo\Recipe\EditablePlanInterface;
use Teknoo\Space\Object\Config\Exception\UnsupportedClusterTypeException;

/**
 * Directory mapping a cluster `type` (e.g. `kubernetes`, `docker-compose`) to the provisioning plan for each
 * role. Every lookup throws {@see UnsupportedClusterTypeException} when the type has no registered plan set.
 *
 * @copyright   Copyright (c) EIRL Richard Déloge (https://deloge.io - richard@deloge.io)
 * @copyright   Copyright (c) SASU Teknoo Software (https://teknoo.software - contact@teknoo.software)
 * @license     http://teknoo.software/license/bsd-3         3-Clause BSD License
 * @author      Richard Déloge <richard@teknoo.software>
 */
interface ProvisioningPlanDirectoryInterface
{
