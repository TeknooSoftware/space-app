...
class PersistedVariableEncryption
{
    public function __construct(
        private readonly ?EncryptionInterface $service,
    ...
    {
        if (!$this->service instanceof EncryptionInterface || $encryptableVariable->isEncrypted()) {
    ...
    {
        if (!$this->service instanceof EncryptionInterface || $encryptableVariable->mustEncrypt()) {
            $promise->success($encryptableVariable);
