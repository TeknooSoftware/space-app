 ...
 * @author Richard Déloge <richard@teknoo.software>
 *
 * @covers \Teknoo\Space\Infrastructures\Doctrine\Repository\ODM\ProjectMetadataRepository
 */
class ProjectMetadataRepositoryTest extends TestCase
{
    ...
    {
        return new ProjectMetadataRepository($this->getDoctrineObjectRepositoryMock());
    }
}
