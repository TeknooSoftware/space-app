...
/**
 * Class PersistedVariableRepositoryTest.
 *
 * @copyright Copyright (c) EIRL Richard Déloge (richard@teknoo.software)
 * @copyright Copyright (c) SASU Teknoo Software (https://teknoo.software)
 * @author Richard Déloge <richard@teknoo.software>
 *
 * @covers \Teknoo\Space\Infrastructures\Doctrine\Repository\ODM\PersistedVariableRepository
 */
class PersistedVariableRepositoryTest extends TestCase
{
    ...
    {
        return new PersistedVariableRepository($this->getDoctrineObjectRepositoryMock());
    }
}
