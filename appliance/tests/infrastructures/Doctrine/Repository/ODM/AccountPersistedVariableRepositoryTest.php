...
/**
 * Class AccountPersistedVariableRepositoryTest.
 *
 * @copyright Copyright (c) EIRL Richard Déloge (richard@teknoo.software)
 * @copyright Copyright (c) SASU Teknoo Software (https://teknoo.software)
 * @author Richard Déloge <richard@teknoo.software>
 *
 * @covers \Teknoo\Space\Infrastructures\Doctrine\Repository\ODM\AccountPersistedVariableRepository
 */
class AccountPersistedVariableRepositoryTest extends TestCase
{
    ...
    {
        return new AccountPersistedVariableRepository($this->getDoctrineObjectRepositoryMock());
    }
}
