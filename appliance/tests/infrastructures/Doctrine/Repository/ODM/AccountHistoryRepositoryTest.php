 ...
 * @author Richard Déloge <richard@teknoo.software>
 *
 * @covers \Teknoo\Space\Infrastructures\Doctrine\Repository\ODM\AccountHistoryRepository
 */
class AccountHistoryRepositoryTest extends TestCase
{
    ...
    {
        return new AccountHistoryRepository($this->getDoctrineObjectRepositoryMock());
    }
}
