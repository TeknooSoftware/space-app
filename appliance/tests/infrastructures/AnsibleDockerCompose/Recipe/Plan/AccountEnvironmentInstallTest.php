...
class AccountEnvironmentInstallTest extends TestCase
{
    ...
    private LogDeployUserInRegistries&Stub $logDeployUserInRegistries;
    ...
    protected function setUp(): void
    {
        ...
        $this->logDeployUserInRegistries = $this->createStub(LogDeployUserInRegistries::class);
        ...
        $this->accountEnvironmentInstall = new AccountEnvironmentInstall(
            ...
            logDeployUserInRegistries: $this->logDeployUserInRegistries,
