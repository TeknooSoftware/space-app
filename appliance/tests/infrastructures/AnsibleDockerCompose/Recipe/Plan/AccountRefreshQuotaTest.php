...
use Teknoo\Space\Infrastructures\AnsibleDockerCompose\Recipe\Plan\AccountRefreshQuota;
...
class AccountRefreshQuotaTest extends TestCase
{
    ...
    private SkipQuotaRefresh&Stub $skipQuotaRefresh;
