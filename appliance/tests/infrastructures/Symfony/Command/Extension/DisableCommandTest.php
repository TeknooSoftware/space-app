...
class DisableCommandTest extends TestCase
{
    ...
    {
        $this->assertEquals('teknoo:space:extension:disable', $this->disableCommand->getName());
    }
    ...
    public function testExecuteWithInvalidExtensionName(): void
    {
        ...
        $this->assertSame(
            Command::INVALID,
            $this->disableCommand->run($this->createInput(null), $output),
        );
    ...
    public function testExecuteWithUnknownExtension(): void
    {
        ...
        $this->assertSame(
            Command::INVALID,
            $this->disableCommand->run($this->createInput('Unknown'), $output),
        );
