...
use Teknoo\Space\Infrastructures\Symfony\Form\Type\Project\VarsSetType;
 ...
 * @author Richard Déloge <richard@teknoo.software>
 *
 * @covers \Teknoo\Space\Infrastructures\Symfony\Form\Type\Project\VarsSetType
 */
class VarsSetTypeTest extends TestCase
{
    ...
    {
        self::assertIsString(
            $this->varsSetType->getBlockPrefix(),
        );
    }
