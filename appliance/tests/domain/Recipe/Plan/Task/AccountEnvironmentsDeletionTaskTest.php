...
/**
 * Class AccountEnvironmentsDeletionTaskTest.
 *
 * @copyright Copyright (c) EIRL Richard Déloge (https://deloge.io - richard@deloge.io)
 * @copyright Copyright (c) SASU Teknoo Software (https://teknoo.software - contact@teknoo.software)
 * @license     http://teknoo.software/license/bsd-3         3-Clause BSD License
 * @author Richard Déloge <richard@teknoo.software>
 */
#[CoversClass(AccountEnvironmentsDeletionTask::class)]
class AccountEnvironmentsDeletionTaskTest extends TestCase
{
    private function buildPlan(): AccountEnvironmentsDeletionTask
    {
        return new AccountEnvironmentsDeletionTask(
            ...
            deleteNamespaces: $this->createStub(DeleteNamespaces::class),
    ...
    public function testConstruct(): void
    {
        $this->assertInstanceOf(
            AccountEnvironmentsDeletionTask::class,
            $this->buildPlan(),
        );
    }
