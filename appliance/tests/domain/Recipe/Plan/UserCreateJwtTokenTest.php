 ...
 *
 */
#[CoversClass(UserCreateJwtToken::class)]
class UserCreateJwtTokenTest extends TestCase
{
    ...
    public function testConstruct(): void
    {
        $this->assertInstanceOf(
            UserCreateJwtToken::class,
            $this->UserCreateJwtToken,
        );
    }
