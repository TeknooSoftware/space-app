...
/**
 * Class PersistedVariableWriterTest.
 *
 * @copyright Copyright (c) EIRL Richard Déloge (richard@teknoo.software)
 * @copyright Copyright (c) SASU Teknoo Software (https://teknoo.software)
 * @author Richard Déloge <richard@teknoo.software>
 *
 * @covers \Teknoo\Space\Writer\PersistedVariableWriter
 */
class PersistedVariableWriterTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->persistedVariableWriter = new PersistedVariableWriter(
            $this->manager,
            $this->datesService,
