...
class AccountPersistedVariableTest extends TestCase
{
    ...
    public function testGetAccount(): void
    {
        ...
        $this->assertEquals($expected, $this->accountPersistedVariable->getAccount());
    }
    ...
    public function testGetName(): void
    {
        ...
        $property = new ReflectionClass(AccountPersistedVariable::class)
            ->getProperty('name');
        $property->setValue($this->accountPersistedVariable, $expected);
        $this->assertEquals($expected, $this->accountPersistedVariable->getName());
    }
    ...
    public function testGetValue(): void
    {
        ...
        $property = new ReflectionClass(AccountPersistedVariable::class)
            ->getProperty('value');
        $property->setValue($this->accountPersistedVariable, $expected);
        $this->assertEquals($expected, $this->accountPersistedVariable->getValue());
    }
    ...
    public function testGetEnvName(): void
    {
        ...
        $property = new ReflectionClass(AccountPersistedVariable::class)
            ->getProperty('envName');
        $property->setValue($this->accountPersistedVariable, $expected);
        $this->assertEquals($expected, $this->accountPersistedVariable->getEnvName());
    }
