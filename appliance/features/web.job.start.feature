Feature: Web interface to create new job and deploy project
  ...
  Scenario: From the UI, execute a job from an owned project, without prefix, a valid paas file, on cluster supporting
  ...
  Scenario: From the UI, execute a job from an owned project, with prefix, a valid paas file, using conditions and
  ...
  Scenario: From the UI, execute a job from an owned project, with prefix, a valid paas file, jobs and encrypted
  ...
  Scenario: From the UI, execute a job from an owned project, with a valid paas file, using conditions and
  encrypted messages between workers
    Given A Space app instance
    And a kubernetes client
    And a job workspace agent
  ...
  Scenario: From the UI, execute a job from an owned project, with a valid paas file, jobs and encrypted
  messages between workers
    Given A Space app instance
    And a kubernetes client
    And a job workspace agent
