Feature: On a space instance, subscription can be restricted to some user with a code, given by the commercial teams,
  ...
  Scenario: Subscription with a non valid code on a subscription access private instance
  ...
  Scenario: Subscription with a valid code on a subscription access private instance
    Given A Space app instance
    And a kubernetes client
    And a subscription restriction
    And A memory document database
  ...
  Scenario: Subscription with a valid code on a subscription access private instancewith a subscription plan
    Given A Space app instance
    And a kubernetes client
    And a subscription restriction
    And A memory document database
  ...
  Scenario: Subscription on a public instance
    Given A Space app instance
    And a kubernetes client
  ...
  Scenario: Subscription on a public instance with a subscription plan
    Given A Space app instance
    And a kubernetes client
    And without a subscription restriction
    And A memory document database
