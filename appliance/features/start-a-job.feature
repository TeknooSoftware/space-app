Feature: On a space instance, we can start a job from a project, User can define some variable.
  ...
  Scenario: Execute a job from a projet with prefix and defined quota and paas file is valid without resources defined
    Given A Space app instance
    And a kubernetes client
    And a job workspace agent
    And a git cloning agent
  ...
  Scenario: Execute a job from a projet with encrypted message and prefix and defined quota and paas file is valid without resources defined
    Given A Space app instance
    And encryption capacities between servers and agents
    And a kubernetes client
    And a job workspace agent
  ...
  Scenario: Execute a job from a projet with prefix and defined quota and paas file is valid with partial resources defined
    Given A Space app instance
    And a kubernetes client
    And a job workspace agent
    And a git cloning agent
  ...
  Scenario: Execute a job from a projet with encrypted message and prefix and defined quota and paas file is valid with partial resources defined
    Given A Space app instance
    And encryption capacities between servers and agents
    And a kubernetes client
    And a job workspace agent
  ...
  Scenario: Execute a job from a projet with prefix and defined quota and paas file is valid with full resources defined
    Given A Space app instance
    And a kubernetes client
    And a job workspace agent
    And a git cloning agent
  ...
  Scenario: Execute a job from a projet with encrypted message and prefix and defined quota and paas file is valid with full resources defined
    Given A Space app instance
    And encryption capacities between servers and agents
    And a kubernetes client
    And a job workspace agent
  ...
  Scenario: Execute a job from a projet with prefix and defined quota and paas file is valid with quota exceeded
    Given A Space app instance
    And a kubernetes client
    And a job workspace agent
    And a git cloning agent
  ...
  Scenario: Execute a job from a projet with encrypted message and prefix and defined quota and paas file is valid with quota exceeded
    Given A Space app instance
    And encryption capacities between servers and agents
    And a kubernetes client
    And a job workspace agent
