Feature: On a space instance, we can start a job from a project, User can define some variable.
  ...
  Scenario: Execute a job from a projet with encrypted message and prefix and defined quota and paas file is valid
  ...
  Scenario: Execute a job from a projet with prefix and defined quota and paas file is valid
  with partial resources defined
    Given A Space app instance
    And a kubernetes client
    And a job workspace agent
    And a git cloning agent
