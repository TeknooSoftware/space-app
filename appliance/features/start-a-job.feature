Feature: On a space instance, we can start a job from a project, User can define some variable.
  ...
  Scenario: Execute a job from a project and it takes too long
  ...
  Scenario: Execute a job from a project and it takes too long with a paas file extends
    Given A Space app instance
    And a kubernetes client
    And a job workspace agent
    And a git cloning agent
  ...
  Scenario: Execute a job from a project with prefix and paas file is valid
    Given A Space app instance
    And a kubernetes client
    And a job workspace agent
    And a git cloning agent
  ...
  Scenario: Execute a job from a project with encrypted message and prefix and defined quota and paas file is valid with quota exceeded
    Given A Space app instance
    And encryption capacities between servers and agents
    And a kubernetes client
    And a job workspace agent
