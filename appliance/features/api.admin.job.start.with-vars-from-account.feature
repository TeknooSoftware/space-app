Feature: API admin endpoints to create new job and deploy project with variables from account's configuration
  ...
  Scenario: From the API, as Admin, execute a job from a project, with account's variables, prefix, a valid paas file,
  ...
  Scenario: From the API, as Admin, re-execute a job from a project, with account's variables, prefix, a valid paas
  ...
  Scenario: From the API, as Admin, execute a job from a project, with account's variables, prefix, defined quota,
  ...
  Scenario: From the API, as Admin, execute a job from a project, with account's variables, prefix, defined quota, with
  ...
  Scenario: From the API, as Admin, execute a job from a project, with account's variables, prefix, a valid paas
  ...
  Scenario: From the API, as Admin, execute a job from a project, without account's variables, prefix, a valid paas file
  ...
  Scenario: From the API, as Admin, execute a job from a project, with account's variables, a valid paas file,
