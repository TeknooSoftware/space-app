@api
Feature: API endpoints to manage variables and secrets usable in all deployments jobs of project
  ...
  Scenario: From the API, get a non-owned project' variables and get an error
    Given an account for "My Company" with the account namespace "my-company"
    And a user, called "Dupont" "Jean" with the "dupont@teknoo.space" with the password "Test2@Test"
    And the 2FA authentication is enabled for the last user
  ...
  Scenario: From the API, edit a non-owned project's variables, via a request with a form url encoded body and get an error
    Given an account for "My Company" with the account namespace "my-company"
    And a user, called "Dupont" "Jean" with the "dupont@teknoo.space" with the password "Test2@Test"
    And the 2FA authentication is enabled for the last user
    And an account for "An Other Company" with the account namespace "my-company"
  ...
  Scenario: From the API, edit a non-owned project's variables, via a request with a json body and get an error
    Given an account for "My Company" with the account namespace "my-company"
    And a user, called "Dupont" "Jean" with the "dupont@teknoo.space" with the password "Test2@Test"
    And the 2FA authentication is enabled for the last user
    And an account for "An Other Company" with the account namespace "my-company"
  ...
  Scenario: From the API, edit an owned project's variables with secrets encryptions, via a request with a form url encoded body
  ...
  Scenario: From the API, edit a non-owned project's variables with secrets encryptions, via a request with a form url encoded body and get an error
    Given encryption of persisted variables in the database
    And an account for "My Company" with the account namespace "my-company"
    And a user, called "Dupont" "Jean" with the "dupont@teknoo.space" with the password "Test2@Test"
    And the 2FA authentication is enabled for the last user
  ...
  Scenario: From the API, edit a non-owned project's variables with secrets encryptions, via a request with a json body and get an error
    Given encryption of persisted variables in the database
    And an account for "My Company" with the account namespace "my-company"
    And a user, called "Dupont" "Jean" with the "dupont@teknoo.space" with the password "Test2@Test"
    And the 2FA authentication is enabled for the last user
