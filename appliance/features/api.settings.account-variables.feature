Feature: On a space instance, an API is available to manage its account' variables
  ...
  Scenario: Create new account variables via the API with secrets encryptions as Admin
    Given A Space app instance
    And A memory document database
  ...
  Scenario: Create new account variables via the API with a json body with secrets encryptions as Admin
    Given A Space app instance
    And A memory document database
    And encryption of persisted variables in the database
    And an account for "My Company" with the account namespace "my-company"
  ...
  Scenario: Update or delete account variables via the API with secrets encryptions as Admin
    Given A Space app instance
    And A memory document database
    And encryption of persisted variables in the database
    And an account for "My Company" with the account namespace "my-company"
  ...
  Scenario: Update or delete account variables via the API with a json body with secrets encryptions as Admin
    Given A Space app instance
    And A memory document database
    And encryption of persisted variables in the database
    And an account for "My Company" with the account namespace "my-company"
