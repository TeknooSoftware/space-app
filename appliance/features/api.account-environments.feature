Feature: On a space instance, an API is available to manage its account's environments
  ...
  Scenario: Update my account's environments via API and create a new environment on a catalog cluster
  ...
  Scenario: Update my account's environments via API and create a new environment on a catalog cluster with a json body
    Given A Space app instance
    And A memory document database
    And a kubernetes client
    And an account for "My Company" with the account namespace "my-company"
  ...
  Scenario: Update my account's read only environments via API and get an error
    Given A Space app instance
    And A memory document database
    And an account for "My Company" with the account namespace "my-company"
    And an user, called "Dupont" "Jean" with the "dupont@teknoo.space" with the password "Test2@Test"
  ...
  Scenario: Update my account's read only environments via API with a json body and get an error
    Given A Space app instance
    And A memory document database
    And an account for "My Company" with the account namespace "my-company"
    And an user, called "Dupont" "Jean" with the "dupont@teknoo.space" with the password "Test2@Test"
  ...
  Scenario: Update my account and exceed environments allowed via API and get an error
    Given A Space app instance
    And A memory document database
    And an account for "My Company" with the account namespace "my-company"
    And an user, called "Dupont" "Jean" with the "dupont@teknoo.space" with the password "Test2@Test"
  ...
  Scenario: Update my account and exceed environments allowed via API with a json body and get an error
    Given A Space app instance
    And A memory document database
    And an account for "My Company" with the account namespace "my-company"
    And an user, called "Dupont" "Jean" with the "dupont@teknoo.space" with the password "Test2@Test"
  ...
  Scenario: Update my account's environments via API and create a new environment on a account cluster
    Given A Space app instance
    And A memory document database
    And a kubernetes client
    And an account for "My Company" with the account namespace "my-company"
    ...
    When the API is called to update account's settings:
      ...
      | space_account.environmentResumes.1.envName              | prod              |
      | space_account.environmentResumes.2.accountEnvironmentId |                   |
      | space_account.environmentResumes.2.clusterName          | Cluster Company   |
      | space_account.environmentResumes.2.envName              | testing           |
    Then get a JSON reponse
    And the serialized account "My Company"
  ...
  Scenario: Update my account's environments via API and create a new environment on a account cluster with a json body
    Given A Space app instance
    And A memory document database
    And a kubernetes client
    And an account for "My Company" with the account namespace "my-company"
  ...
  Scenario: Update my account and exceed environments allowed with an env on an account cluster via API and get an error
    Given A Space app instance
    And A memory document database
    And an account for "My Company" with the account namespace "my-company"
    And an account clusters "Cluster Company" and a slug "my-company-cluster"
