Feature: API admin endpoints to create new job and deploy project with variables from project's configuration
  ...
  Scenario: From the API, as Admin, execute a job from a project, with project's variables, prefix, a valid paas file,
  ...
  Scenario: From the API, as Admin, re-execute a job from a project, with project's variables, prefix, a valid paas
  ...
  Scenario: From the API, as Admin, execute a job from a project, with project's variables, prefix, defined quota,
  ...
  Scenario: From the API, as Admin, execute a job from a project, with project's variables, prefix, defined quota, with
  ...
  Scenario: From the API, as Admin, execute a job from a project, with project's variables, prefix, a valid paas
  ...
  Scenario: From the API, as Admin, execute a job from a project, without project's variables, prefix, a valid paas file
  ...
  Scenario: From the API, as Admin, execute a job from a project, with project's variables, a valid paas file,
  ...
  Scenario: From the API, as Admin, execute a job from a project, with project's variables, prefix, a valid paas
  file, using conditions via a request with a json body
    Given A Space app instance
    And a kubernetes client
    And a job workspace agent
    And a git cloning agent
