Feature: API endpoints to create new job and deploy project with variables from account's configuration
  ...
  Scenario: From the API, execute a job from an owned project, with account's encrypted variable, prefix, a valid
  ...
  Scenario: From the API, execute a job from an owned project, with account's two encrypted variables, prefix, a valid
  paas file, via a request with a form url encoded body
    Given A Space app instance
    And encryption of persisted variables in the database
    And a kubernetes client
  ...
  Scenario: From the API, execute a job from an owned project, with account's encrypted variables, prefix, a valid
  ...
  Scenario: From the API, re-execute a job from an owned project, with account's encrypted variables, prefix, a
  ...
  Scenario: From the API, execute a job from an owned project, with account's encrypted variables, prefix, defined
  ...
  Scenario: From the API, execute a job from an owned project, with account's encrypted variables, a valid paas file,
